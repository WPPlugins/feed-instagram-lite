					...
					<?php
						if ( $action_links ) {
							...
							switch( $plugin["slug"] ){
								...
								echo '<li><a class="button" aria-label="PRO VERSION DEMO" href="http://demo.ghozylab.com/plugins/easy-contact-form-plugin/demo-form-job-application/" target="_blank">PRO VERSION DEMO</a></li>';
								break;
